...
const LinkPayment: React.FC = () => {
  ...
  const columns : TableColumn<DataType>[] = [
    ...
    {
      name: 'Durum',
      selector: row => <Badge badgeColor={row.badge} text={badgeText[row.badge]} />,
      grow:4
    },
    {
      name: '',
      selector: row => (
        <div className="flex flex-col gap-1 2xl:flex-row 2xl:gap-0 items-center">
          <Button isLink={true} className="hover:no-underline">
            <IconEyeComplete width={24} height={24} viewBox="0 0 24 24" className="text-primary" />
            Görüntüle
          </Button>
          <Button isLink={true} className="hover:no-underline !text-orange">
            <IconPen width={24} height={24} viewBox="0 0 24 24" className="text-orange" />
            Düzenle
          </Button>
        </div>
      ),
          ...
          <div className="w-full h-full flex flex-col">
            <div className="w-full flex justify-between items-center">
              ...
              <div className="flex items-center gap-6">
                ...
                <SelectInput className="!px-4" size="middle" placeholder="5" isError={false} />
