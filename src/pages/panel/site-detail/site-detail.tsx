...
import { IconArrowRight, IconDelete, IconPen } from "../../../components/icons/icons"
    ...
    return (
          ...
          <div className="w-full h-full flex flex-col">
            <div className="w-full flex justify-between items-end">
              ...
              <div className="flex items-center gap-4"> 
                <Button onClick={() => setModalIsOpen(true)} variant="primary" isLight={true} className="!text-primary">
            ...
            <div className="w-full flex-grow">
                ...
                <div className="grid grid-cols-2 gap-6 mt-4">
                    <Input label="Web Site / İş Yeri / Mağaza Adı" isSimple={true} />
      ...
      <div className="container w-full grid grid-cols-3 gap-6 p-4 mb-6">
        <div className="w-full bg-actual-white p-6 rounded-2.5xl">
            <h1 className="text-lg text-base-content font-medium">Banka Listesi</h1>
            <p className="text-sm text-base-content-60 mt-4">Mozzarella buffalo wing meatball style white extra. Peppers mozzarella tomatoes thin bell lot ipsum pan roll buffalo.</p>
            <Button variant="primary" isLight={true} className="!text-primary mt-6">
                İncele
                <IconArrowRight width={20} height={20} viewBox="0 0 20 20" />
            </Button>
        </div>
        <div className="w-full bg-actual-white p-6 rounded-2.5xl">
            <h1 className="text-lg text-base-content font-medium">Tanımlı Kart Listesi</h1>
            <p className="text-sm text-base-content-60 mt-4">Mozzarella buffalo wing meatball style white extra. Peppers mozzarella tomatoes thin bell lot ipsum pan roll buffalo.</p>
            <Button variant="primary" isLight={true} className="!text-primary mt-6">
                İncele
                <IconArrowRight width={20} height={20} viewBox="0 0 20 20" />
        ...
        <div className="w-full bg-actual-white p-6 rounded-2.5xl">
            <h1 className="text-lg text-base-content font-medium">Taksit / Komisyon Oranları</h1>
            <p className="text-sm text-base-content-60 mt-4">Mozzarella buffalo wing meatball style white extra. Peppers mozzarella tomatoes thin bell lot ipsum pan roll buffalo.</p>
            <Button variant="primary" isLight={true} className="!text-primary mt-6">
                İncele
                <IconArrowRight width={20} height={20} viewBox="0 0 20 20" />
