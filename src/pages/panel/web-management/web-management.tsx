...
import { IconArrowRight, IconFileUpload, IconPlus } from "../../../components/icons/icons"
...
const WebManagement:React.FC = () => {
    ...
    return (
        <>
                ...
                <div className='w-full h-full bg-actual-white rounded-2.5xl p-6'>
                    <div className="w-full h-full flex flex-col">
                        <div className="w-full flex justify-between items-center">
                            <div>
                                <h1 className="text-[18px] text-base-content font-medium">Web Siteleriniz</h1>
                                <p className="text-xs text-base-content-40 mt-2">Lorem, ipsum.</p>
                            </div>
                            <div>
                                <Button onClick={() => setModalIsOpen(true)} variant="primary" className="text-sm !rounded-2xl">
                        ...
                        <div className="w-full flex-grow flex justify-center items-center">
                            <div className="text-center">
                                <img src={clouds} alt="" />
                                <h1 className="text-base-content mt-2">Hiç bir site eklemedin</h1>
            ...
            <Modal state={modalIsOpen} title="Yeni Site Ekle" small={true} setState={setModalIsOpen} subTitle="Lütfen formu doldurunuz.">
                ...
                <div className="p-1">
                    ...
                    <div className="w-full p-4 flex justify-center items-center border-2 border-dashed to-base-content-20 mt-3 rounded-2xl">
                        <label htmlFor="FileInput" className="text-center flex flex-col justify-center items-center gap-1 cursor-pointer">
                            <IconFileUpload />
                ...
                <CheckBox id="checkbox" isChecked={false} label="Bilgilerin doğruluğunu onaylıyorum." className="mt-4 !text-sm !font-normal" />

                <Button variant="primary" shape="full" size="medium" className="mt-6 !text-base !font-medium">
                    Onaya Gönder
                </Button>
            </Modal>
        </>
